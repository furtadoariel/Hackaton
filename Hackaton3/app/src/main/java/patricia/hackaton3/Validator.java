...
public class Validator {
    ...
    public final static boolean validatePassword(String txtPassword) {
        if (TextUtils.isEmpty(txtPassword)) {//caso o campo esteja em branco
            return false;
        } else if ( txtPassword.length() < 4) { //caso a senha tenha menos de 4 caracteres
            return false;
        } else {
            return true;
        }
